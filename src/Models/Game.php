...
class Game
{
    ...
    public function __construct(array $input)
    {
        ...
        $this->gHomeGoals = Json::intOrNull($input["gHomeGoals"]);
        $this->gGuestGoals = Json::intOrNull($input["gGuestGoals"]);
        $this->gHomeGoals_1 = Json::intOrNull($input["gHomeGoals_1"]);
        $this->gGuestGoals_1 = Json::intOrNull($input["gGuestGoals_1"]);
        $this->gHomePoints = Json::intOrNull($input["gHomePoints"]);
        $this->gGuestPoints = Json::intOrNull($input["gGuestPoints"]);
